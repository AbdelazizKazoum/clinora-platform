...
const mapSubmissionError = (error: unknown): CreateStaffFormErrors => {
  if (error instanceof ApiError) {
    ...
    const message =
      error.message || 'Unable to create the staff member. Check the form and try again.';
  ...
  return (
    <>
      ...
      <div className="d-flex flex-wrap justify-content-end gap-2 mb-3">
        <Link className="btn btn-outline-secondary" href="/staff">
            ...
            <CardBody>
              <Form noValidate onSubmit={handleSubmit}>
                ...
                <Row>
                  ...
                  <Col md={6}>
                    <FormGroup className="mb-3">
                      <FormLabel htmlFor="staff-avatar">Avatar URL</FormLabel>
                      <FormControl
                        disabled={isPending}
                        id="staff-avatar"
          ...
          <Card>
            <CardBody className="text-center">
              <div className="avatar avatar-xl mx-auto mb-3">
                <span className="avatar-title bg-primary-subtle text-primary rounded-circle fw-bold fs-3">
                  {initialsPreview}
                </span>
              </div>
              <h5 className="mb-1">
