          ...
          <div className="d-flex align-items-center">
            ...
            <div>
              ...
              <h5 className="fs-base mb-0">
                <Link href="/dashboard" className="text-body">
                  {row.original.name}
                </Link>
              </h5>
            </div>
      ...
      cell: ({ row }) => (
        <>
          ...
          <h5 className="fs-base mb-0 fw-normal">
            ...
            <span className="ms-1">
              <Link href="/dashboard" className="link-reset fw-semibold">
  ...
  return (
    <Card>
        ...
        <div className="d-flex gap-2">
          <Link href="/dashboard" passHref>
            <Button variant="soft-secondary" size="sm">
              <IconifyIcon icon="tabler:plus" className="me-1" /> Add Supply
            </Button>
          </Link>
      ...
      <CardBody className="p-0">
        <DataTable<ProductType> table={table} emptyMessage="No supplies found" className=" table-centered table-custom table-sm table-nowrap table-hover mb-0" showHeaders={false} />
      </CardBody>
